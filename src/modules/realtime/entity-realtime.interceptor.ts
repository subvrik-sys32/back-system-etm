// src/modules/realtime/entity-realtime.interceptor.ts
...
export const RealtimeEntity = (entity: string) =>
  Reflect.metadata(REALTIME_ENTITY_KEY, entity);
...
@Injectable()
export class EntityRealtimeInterceptor implements NestInterceptor {
